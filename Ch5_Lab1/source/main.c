...
void minimum(int grade[][EXAMS], int puils, int tests);
void maximum(int grade[][EXAMS], int puils, int tests);
void average(int grade[][EXAMS], int puils, int tests);
void printArray(int grade[][EXAMS], int puils, int tests);
void printMenu(void);
